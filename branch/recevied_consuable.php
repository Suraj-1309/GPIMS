...
<body>
    ...
    <div class="p-3 ml-5 pl-4">
            <h2>Received Consumable Items By Lab</h2>
        </div>
        <style>
            h2{
                padding-top: 2%;
        ...
        <div class="container mt-4">
            ...
            <table class="table table-bordered" id="myTable">
                ...
                <tbody>
                    ...
                    $branch = $_SESSION['branch'];
                    $lab = $_SESSION['lab'];
                    $sql = "SELECT * FROM `rr_recevied_branch` WHERE `branch` = '$_SESSION[branch]' AND `lab` = '$_SESSION[lab]' AND `type` = 'Consumable Item' ORDER BY `sno` DESC";
