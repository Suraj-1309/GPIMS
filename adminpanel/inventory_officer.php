...
<body>
    ...
    <div id="admin" class="right">
        ...
        if (isset($_GET['delete'])) {
            ...
            if ($result) {
                $_SESSION['message'] = "Inventory Officer has been Deleted successfully.";
                $_SESSION['message_type'] = "success";
            } else {
                $_SESSION['message'] = "Inventory Officer been Deleted successfully.";
                $_SESSION['message_type'] = "success";
            }
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModelLabel">Edit This Inventory Officer</h5>
        ...
        <div class="container">
            <table class="table table-bordered" id="myTable">
                ...
                <tbody>
                    ...
                    $sql = "SELECT * FROM `user_login` WHERE `branch` = 'INVENTORY_OFFICER' AND `lab` = 'INVENTORY_OFFICER'";
                ...
                Array.from(deletes).forEach(element => {
                    element.addEventListener("click", (e) => {
                        ...
                        if (confirm("Press a button!")) {
                            console.log("yes");
                            window.location = `/try/adminpanel/inventory_officer.php?delete=${sno}`;
                        } else {
                            console.log("No");
                        }
                    });
