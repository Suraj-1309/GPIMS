    ...
    <div id="admin" class="right">
        ...
        if ($_SERVER['REQUEST_METHOD'] == "POST") {
            if (isset($_POST['snoAccept'])) {
                ...
                $sql_update_permission = "UPDATE return_request SET permission = 'admin' WHERE sno = '$snoAccept'";
        ...
        <div class="container">
            <table class="table table-bordered" id="myTable">
                ...
                <tbody>
                    <?php
                    $sql = "SELECT * FROM `return_request` WHERE `permission` = 'Stock Officer' ORDER BY `sno` DESC";
